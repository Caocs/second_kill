 ...
 * @date 2021/10/23
 * <p>
 * 本套代码中，Springboot2.x+Redis3.2.x。然后使用jedis连接池。
 * <p>
 */
...
public class RedisConfig {
    ...
    /**
     * 重新定义RedisTemplate，并设置key及value的序列化方式。
     * <p>
     ...
     */
    @Bean
    public DefaultRedisScript<Boolean> redisLockDeleteScript() {
